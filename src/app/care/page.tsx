  ...
  return (
    <div className="min-h-screen flex flex-col justify-between bg-[#F4F4F1] text-[#635F58]">
      ...
      <main className="flex-1 pt-32 pb-24 px-4 sm:px-8 max-w-4xl mx-auto w-full">
        {/* Header Banner */}
        <div className="border-b border-[#635F58]/20 pb-10 mb-14 text-center">
          <span className="text-xs uppercase tracking-[0.3em] text-[#bdb2a1] font-medium block mb-3">
            A benefit of KSHAUM Ownership
          </span>
          <h1 className="text-3xl sm:text-4xl md:text-5xl font-light tracking-[0.15em] uppercase text-[#635F58] font-serif mb-4">
            CARE FOR A LIFETIME
          </h1>
          <p className="text-sm sm:text-base text-[#635F58]/80 max-w-xl mx-auto italic font-serif">
            A KSHAUM piece is made to remain.
          </p>
        </div>

        {/* Intro Statement Card */}
        <div className="bg-[#F4F4F1] p-8 sm:p-12 rounded-sm border border-[#635F58]/20 shadow-xs mb-12">
          <p className="text-sm sm:text-base leading-relaxed text-[#635F58]/90 font-light mb-6">
          ...
          <p className="text-sm sm:text-base leading-relaxed text-[#635F58]/90 font-light">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8 mb-12">
          {/* Ownership */}
          <div className="bg-[#F4F4F1] p-8 rounded-sm border border-[#635F58]/20 shadow-xs flex flex-col justify-between">
            <div>
              <div className="flex items-center gap-2 mb-4">
                <span className="w-6 h-px bg-[#bdb2a1]"></span>
                <h2 className="text-xs uppercase tracking-[0.25em] font-semibold text-[#635F58]">
                  Ownership
                </h2>
              </div>
              <p className="text-xs sm:text-sm text-[#635F58]/80 leading-relaxed font-light">
          ...
          <div className="bg-[#F4F4F1] p-8 rounded-sm border border-[#635F58]/20 shadow-xs flex flex-col justify-between">
            <div>
              ...
              <p className="text-xs sm:text-sm text-[#635F58]/80 leading-relaxed font-light mb-3">
                Repair and restoration are available throughout the life of the piece.
              </p>
              <p className="text-xs sm:text-sm text-[#635F58]/70 leading-relaxed font-light">
        ...
        <div className="bg-[#F4F4F1] p-8 sm:p-10 rounded-sm border border-[#635F58]/20 mb-12">
          <h3 className="text-xs uppercase tracking-[0.2em] font-semibold text-[#635F58] mb-4">
            Repair & Restoration Considerations
          </h3>
          <p className="text-xs sm:text-sm leading-relaxed text-[#635F58]/80 font-light mb-4">
          ...
          <div className="p-4 bg-[#F4F4F1]/70 border-l-2 border-[#635F58] rounded-xs">
            <p className="text-xs text-[#635F58]/85 leading-relaxed italic">
        ...
        <div className="text-center bg-[#635F58] text-[#F4F4F1] p-10 sm:p-14 rounded-sm shadow-md">
          ...
          <div className="pt-2">
            <a
              ...
              className="inline-block bg-[#F4F4F1] text-[#635F58] hover:bg-[#c9c5ba] text-xs uppercase tracking-[0.25em] font-medium py-3.5 px-8 transition-colors border border-[#F4F4F1]"
            >
              Request Care
            </a>
          </div>
