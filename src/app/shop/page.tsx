...
function ShopContent() {
  ...
  // Load products based on category, search, and sort
  useEffect(() => {
        ...
        <div className="py-6 flex flex-col md:flex-row justify-between items-center gap-4 border-b border-[#635F58]/20 mb-8">
          ...
          <div className="flex items-center gap-4 text-[11px]">
            ...
            <div className="flex items-center gap-1.5">
              <label htmlFor="shop-sort" className="uppercase tracking-wider text-[#635F58]/60 hidden sm:inline">
                Sort:
              </label>
              <select
                id="shop-sort"
                ...
                className="bg-transparent border border-[#635F58]/20 px-2.5 py-1 text-[11px] uppercase tracking-wider text-[#635F58] focus:outline-none cursor-pointer"
              >
