            ...
            <div className="flex flex-wrap gap-2">
              {categories.map((cat) => (
                <button
                  ...
                  className={`text-xs uppercase tracking-widest px-3 py-1 border transition-all cursor-pointer ${
                ...
                <div key={product.id} className="group mb-4">
                  <Link href={`/product/${product.slug}`}>
                    ...
                    <div className="flex justify-between items-start">
                      ...
                      <span className="text-xs sm:text-sm text-[#1c1c1a] font-light ml-2">
