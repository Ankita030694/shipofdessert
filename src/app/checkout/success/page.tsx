...
function SuccessContent() {
  ...
  return (
    <div className="max-w-3xl mx-auto w-full">
      {/* Thank you card */}
      <div className="bg-[#635F58] p-8 sm:p-12 rounded-sm border border-[#F4F4F1]/15 shadow-xl text-center space-y-8">
        ...
        <div className="bg-[#635F58]/80 border border-[#F4F4F1]/10 p-5 rounded-xs space-y-2">
        ...
        <div className="border-t border-b border-[#F4F4F1]/10 py-6 text-left space-y-4">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-4 gap-3 text-xs">
            <div className="p-3 bg-[#635F58]/60 rounded-xs border border-emerald-300">
            ...
            <div className="p-3 bg-[#635F58]/60 rounded-xs border border-[#F4F4F1]/20">
        ...
        <div className="flex flex-col sm:flex-row items-center justify-center gap-4 pt-2">
          <Link
            href="/collection"
            className="w-full sm:w-auto px-8 py-3.5 bg-[#F4F4F1] text-[#635F58] text-xs uppercase tracking-widest font-medium hover:bg-[#eaeae7] transition-colors shadow-xs"
          >
            Explore More Collections
          </Link>
          <Link
            href="/"
            className="w-full sm:w-auto px-8 py-3.5 border border-[#F4F4F1]/20 text-xs uppercase tracking-widest font-medium hover:bg-[#F4F4F1] hover:text-[#635F58] transition-colors"
          >
            Return to Home
          </Link>
        </div>
