      ...
      <main className="container mx-auto px-4 sm:px-6 lg:px-8 pt-28 pb-20 flex-1 max-w-7xl">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-10 lg:gap-14 mb-24 items-start">
          ...
          <div className="lg:col-span-7">
            <div className="relative aspect-[3/4] bg-[#e8e4dc]/30 rounded-xs overflow-hidden border border-[#1c1c1a]/10 max-h-[780px] group select-none">
                ...
                <>
                  {activeImageIndex > 0 && (
                    <button
                      ...
                      className="absolute left-3 top-1/2 -translate-y-1/2 w-9 h-9 rounded-full bg-[#DBD8CF]/85 hover:bg-[#DBD8CF] text-[#1c1c1a] border border-[#1c1c1a]/20 flex items-center justify-center shadow-md transition-all opacity-0 group-hover:opacity-100 cursor-pointer z-20 backdrop-blur-xs"
                    >
                  ...
                  {activeImageIndex < productImages.length - 1 && (
                    <button
                      ...
                      className="absolute right-3 top-1/2 -translate-y-1/2 w-9 h-9 rounded-full bg-[#DBD8CF]/85 hover:bg-[#DBD8CF] text-[#1c1c1a] border border-[#1c1c1a]/20 flex items-center justify-center shadow-md transition-all opacity-0 group-hover:opacity-100 cursor-pointer z-20 backdrop-blur-xs"
                    >
                      <svg className="w-4 h-4" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                      ...
                      <button
                        ...
                        className={`h-1.5 transition-all duration-300 rounded-full cursor-pointer ${
                          idx === activeImageIndex
                            ? 'w-6 bg-[#1c1c1a]'
                            : 'w-1.5 bg-[#1c1c1a]/30 hover:bg-[#1c1c1a]/60'
                        }`}
                      />
                    ))}
                  </div>
                  ...
                  {/* Image Counter Tag */}
                  <div className="absolute bottom-3 right-3 bg-[#1c1c1a]/70 backdrop-blur-xs text-white text-[10px] tracking-widest font-mono px-2 py-0.5 rounded-xs pointer-events-none z-20">
          ...
          <div className="lg:col-span-5 flex flex-col space-y-6">
            ...
            <div>
              ...
              <h1 className="text-2xl sm:text-3xl font-serif text-[#1c1c1a] font-normal tracking-wide mb-3">
                {product.name}
              </h1>
